...
export const site: SiteInfo = {
  ...
  contacts: [
    ...
    { label: 'LinkedIn', url: 'https://www.linkedin.com/in/kaaveh' },
    { label: 'GitHub', url: 'https://github.com/Kaaveh' },
    { label: 'Medium', url: 'https://medium.com/@Kaaveh' },
    { label: 'YouTube', url: 'https://www.youtube.com/@CodeWithKaaveh' },
  ],
};
